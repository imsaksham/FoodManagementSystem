<%@ Page Title="" Language="C#" MasterPageFile="~/FoodManagement.Master" AutoEventWireup="true" CodeBehind="ChefRegistration.aspx.cs" Inherits="WebApplication1.WebForm6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style8">
        <tr>
            <td style="font-size: xx-large; color: #FF3300">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Restruant&#39;s Chef Registration</td>
        </tr>
    </table>
    <br />
    <table class="auto-style8">
        <tr>
            <td class="auto-style12">
                <asp:Label ID="Label3" runat="server" ForeColor="#FF6699" Text="Chef's First Name: "></asp:Label>
            </td>
        ...
        <tr>
            <td class="auto-style12">
                <asp:Label ID="Label4" runat="server" ForeColor="#FF6699" Text="Chef's Last Name: "></asp:Label>
            </td>
            <td class="auto-style13">
...
&nbsp;<br />Already have an account?
            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/ChefLogin.aspx">Sign in</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
